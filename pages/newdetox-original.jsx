...
<div className="xl:hidden  2xl:hidden lg:hidden md:hidden mb-10 bg-white p-4 rounded-xl mx-3 border-b-2 border-gray-300 ">
      ...
      <div className='xl:hidden m-5 2xl:hidden lg:hidden p-2 md:hidden'>
        <div>
          ...
          <p className='text-left mt-2 p-3 text-lg font-normal text-gray-700'>Ao contrário do que algumas pessoas podem pensar, New Detox não é um Remédio. Diferente de outros termogênicos famosos do mercado, o New Detox é um suplemento alimentar que não promove riscos a saúde.</p>       
